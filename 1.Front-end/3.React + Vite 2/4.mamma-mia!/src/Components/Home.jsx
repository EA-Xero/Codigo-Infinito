...
export default function Home() {
    const {  setNombrepizza, setConteo, Conteo} = useContext(MyContext)
    ...
    function añadir(index) {
        ...
        setConteo([...Conteo, { nombre: pizzaName, cantidad: unitCount }]);
        console.log(`Pizza: ${pizzaName}, Unidades: ${unitCount}`);
    }
    return (
                            ...
                            <div key={item.id} className="card m-3 p-3 bg-info bg-opacity-10 border border-info rounded-end" style={{ width: '18rem' }}>
                                ...
                                <div className="card-body pizza">
                                    ...
                                    <div>
                                        ...
                                        <span itemID={index} className='mx-3 text-light'>{counts[index] || 0}</span>
                                    ...
                                    <div className='text-center'>
                                        ...
                                        <button onClick={() => añadir(index)} className="card-link m-1 btn btn-warning">Añadir a carrito</button>
                                    </div>
                                </div>
                            </div>
                        );
